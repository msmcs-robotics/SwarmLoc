...
void DW1000Class::interruptOnReceiveFailed(boolean val) {
	setBit(_sysmask, LEN_SYS_MASK, LDEERR_BIT, val);  // FIXED: was LEN_SYS_STATUS
	setBit(_sysmask, LEN_SYS_MASK, RXFCE_BIT, val);   // FIXED: was LEN_SYS_STATUS
	setBit(_sysmask, LEN_SYS_MASK, RXPHE_BIT, val);   // FIXED: was LEN_SYS_STATUS
	setBit(_sysmask, LEN_SYS_MASK, RXRFSL_BIT, val);  // FIXED: was LEN_SYS_STATUS
}
