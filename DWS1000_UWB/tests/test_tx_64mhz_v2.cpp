/**
 * TX Test - 64MHz PRF v2 (Preamble Code Fix)
 *
 ...
 * for 64MHz PRF. Library bug: enableMode() changes PRF but doesn't update
 * preamble code, which was set by setDefaults()/setChannel() when PRF was 16MHz.
 *
 * PIN_RST = 7
 */
...
void setup() {
    ...
    DW1000.setChannel(5);  // FIX: re-set channel to get correct preamble code for 64MHz PRF
