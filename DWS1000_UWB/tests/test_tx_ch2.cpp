/**
 * TX Test - Channel 2, 110kbps, 16MHz PRF
 *
 * Same as standard TX but using Channel 2 instead of Channel 5.
 * Channel 2 uses different PLL settings (FS_PLLCFG=0x08400508, FS_PLLTUNE=0x26)
 * vs Channel 5 (FS_PLLCFG=0x0800041D, FS_PLLTUNE=0xBE).
 *
 * PIN_RST = 7
 */
...
void setup() {
    ...
    DW1000.setChannel(2);  // Channel 2 instead of default 5
